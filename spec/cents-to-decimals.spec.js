...
*/
//notes on MATCHERS
//.toEqual recursively checks every field of an object or array. If you want to check the value of an object, use toEqual.
//.toBe uses Object.is to test exact equality.

const { centsToDecimals } = require('../src/cents-to-decimals');
//VScode recommends to turn into a ES module - WHY?
