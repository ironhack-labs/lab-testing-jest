...
const{centsToDecimals} = require('../src/cents-to-decimals') //Para os testes rodarem é preciso digitar essa linha de código para importar o respectivo arquivo do src
